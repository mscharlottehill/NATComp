...
const OMEGA = 0.8; // USER COMMENT: THIS IS VARIED 0.4-0.9
const ALPHA1 = 1.0; // THIS IS VARIED 1.95-2.15
const ALPHA2 = 1.0; // THIS IS VARIED 1.95-2.15
const SWRMSZ = 10; // USER COMMENT: THIS IS CHANGED DYNAMICALLY AFTER COMPILING
const LIMITS = 0.5; // initialisation is within [-LIMITS,LIMITS]^dim

// NO OTHER CHANGES WERE MADE BEYOND THE PARAMETERS ABOVE
